...
export default function Settings() {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <h1 className="pt-[50px] text-3xl font-semibold mb-4">Settings</h1>

      <div className="mb-6">
        <div className="flex items-center">
          <Switch defaultSelected aria-table="Notifications Enabled"  ></Switch>
          { notificationsEnabled ? <p className={`ml-2 ${notificationsEnabled ? 'block' : 'hidden'}`}>Notifications: On </p>
            : <p className={`mr-2 ${notificationsEnabled ? 'hidden' : 'block'}`}>Notifications: Off</p>
          }
      ...
      <button
        className="mr-auto ml-auto w-[200px] bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded mr-4"
      >
        Unlink Insurance
      </button>

      <button onClick={() => {console.log('hi')}} className="mt-[10px] w-[200px] bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded" >
        Deactivate Account
      </button>
